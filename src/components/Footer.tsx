      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4 text-green-100">JournalScript</h3>
            <p className="text-green-200 mb-4 max-w-md">
              A modern blog platform for sharing thoughts, stories, and insights. 
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-green-100">Quick Links</h4>
          ...
          {/* Categories */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-green-100">Categories</h4>
            <ul className="space-y-2">
              <li>
                <Link
        ...
        <div className="mt-8 pt-8 border-t border-green-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link
                href="/privacy"
                className="text-green-200 hover:text-green-100 text-sm transition-colors duration-200"
              >
                Privacy Policy
              </Link>
              <Link
